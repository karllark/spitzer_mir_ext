...
if __name__ == '__main__':
    ...
    starnames = ['hd281159', 'hd283809', 'hd029309', 'hd147933',
                 'hd147889', 'hd096042', 'hd204827', 'vicyg1']
    plot_mir_set(ax, starnames,
                 ann_xvals=[6.0, 6.0], ann_wave_range=[5.0, 9.0])

    ann_set(ax, fontsize, [35.0, 38.0], [4.4, 0.9], [45.0, 42.0],
            'Main Sequence', '(ordered by spectral type)')

    starnames = ['hd029647', 'hd147701', 'hd014956', 'vicyg2',
                 'hd192660', 'hd229238', 'hd112272',
                 'vicyg8a']
    plot_mir_set(ax, starnames, extra_off_val=4.0, ann_xvals=[9.0, 9.0])

    ann_set(ax, fontsize, [35.0, 38.0], [8.9, 4.7], [45.0, 42.0],
            'Giants and Supergiants', '(ordered by spectral type)')
