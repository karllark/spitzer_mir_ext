...
if __name__ == '__main__':
    ...
    ann_set(ax, fontsize, [35.0, 38.0], [4.9, 0.9], [45.0, 42.0],
            'Main Sequence', '(ordered by spectral type)')

    starnames = ['hd029647', 'hd147701', 'hd014956', 'vicyg2',
                 'hd192660', 'hd229238', 'hd112272',
                 'vicyg8a']
    plot_mir_set(ax, starnames, extra_off_val=4.5, ann_xvals=[9.0, 9.0])

    ann_set(ax, fontsize, [35.0, 38.0], [9.4, 5.4], [45.0, 42.0],
